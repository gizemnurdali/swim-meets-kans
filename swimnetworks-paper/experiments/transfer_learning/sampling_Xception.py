...
Outputs: 'Xception_sampling.csv' file with accuracy on training data, test data and sampling time for different widths
'''
import numpy as np
...
# Preprocessing datafor Xception - Inputs pixel values are scaled between -1 and 1, sample-wise
...
data.to_csv('Xception_sampling.csv', index=False)
