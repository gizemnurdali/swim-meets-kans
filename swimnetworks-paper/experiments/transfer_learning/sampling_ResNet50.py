...
Outputs: 'ResNet50_sampling.csv' file with accuracy on training data, test data and sampling time for different widths
'''
...
# Hyper-parameters: Width, activation function
...
for a in range(len(activation_functions)):
    for i in range(len(widths)):
        ...
        # Summary
        print('Summary: Pre-trained neural network - ResNet50, Dataset: CIFAR-10, Head Weights - Sampled')
...
data.to_csv('ResNet50_sampling.csv', index=False)
