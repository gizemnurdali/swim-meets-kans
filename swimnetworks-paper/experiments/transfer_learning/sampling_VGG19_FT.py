...
Outputs: 'VGG19_sampling_ft.csv' file with 
...
for a in range(len(activation_functions)):
    for i in range(len(widths)):
        ...
        '''
        print('\n\nShapes and weights of the tensorflow model after combining the models: \n')
        print('Weights of the last sequential layer: ', model_finetune.layers[-1].get_weights())
        '''
        epochs = 10
...
data.to_csv('VGG19_sampling_ft.csv', index=False)
