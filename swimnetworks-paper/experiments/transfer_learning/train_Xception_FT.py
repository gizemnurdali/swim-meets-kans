...
(x_train,y_train), (x_test,y_test)=cifar10.load_data()[:1000]
...
y_train_original = y_train.copy()[:1000] 
y_test_original = y_test.copy()[:1000] 
...
data.to_csv('Xception_training_ft.csv', index=False)
